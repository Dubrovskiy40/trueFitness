...
const trainings = {
    allTrainings: [
        ...
        },
        {
            ...
            exercises: [
                {
                    exerciseName: 'Становая тяга', exerciseImg: ['stanovaya.jpg'],
                    exerciseDescription:
                ...
                {
                    exerciseName: 'Приседания со штангой', exerciseImg: ['prised.jpg'],
                    exerciseDescription:
                ...
                {
                    exerciseName: 'Жим штанги лёжа на горизонтальной скамье', exerciseImg: ['zhim-shtangi-lezha-1.jpg'],
                    exerciseDescription:
                ...
                {
                    exerciseName: 'Тяга штанги к поясу', exerciseImg: ['tjaga-shtangi-v-naklone_4.jpg'],
                    exerciseDescription:
        ...
        {
            id: 4, img: 'press-preview.png', trainingName: 'Тренировка на пресс', duration: '10-15 минут', fav: 0, likes: 0, dislikes: 0, url: 'press',
            exercises: [
                {
                    exerciseName: 'Скручивания с касанием стоп', exerciseImg: ['skruchivaniya-s-podnyatymi-nogami.jpg'],
                    exerciseDescription:
                        `Лежа на спине, поднимите ноги до перпендикулярного полу положения, после чего согните их в коленях на 90 градусов. Руки подняты над головой и удерживаются на весу.\n\nДалее на выдохе начинаем выполнять скручивание, одновременно подводя руки к голеням через стороны.\n\nНа вдохе переходим в стартовую позицию.\n\nКаждую пиковую точку фиксируйте небольшой паузой.Двигайтесь плавно и без рывков.\n\nУпражнение совмещает динамическую и статическую нагрузку одновременно, что является его главным преимуществом для прокачки пресса.\n\nСколько выполнять: 12-15 повторений.`
                },
                {
                    exerciseName: 'Велосипед', exerciseImg: ['2.jpg'],
                    exerciseDescription:
                        `Находясь лежа на спине, сведите ладони на затылке, а локти направьте в противоположные друг от друга стороны.\n\nДалее приподнимите корпус и ноги от пола, удерживая их на расстоянии 10-15 см от поверхности гимнастического коврика.\n\nТеперь совершаем движение, аналогичное упражнению «велосипед» (колени поочередно поднимаются до уровня груди).\n\nОдновременно с этим поворачиваем корпус, стараясь дотянуться до колена локтем противоположной стороны (правое колено — левый локоть и наоборот).\n\nУпражнение на пресс для мужчин отлично прорабатывает косые и боковые мышцы корпуса, укрепляет брюшные мышцы в целом.\n\nСколько выполнять: 8-10 повторений на каждую сторону.`
                },
                {
                    exerciseName: 'Подъем/опускание ног по очереди', exerciseImg: ['podem-nog-lezha_4.jpg'],
                    exerciseDescription:
                        `Остаемся лежать на полу. Руки вытянуты вдоль корпуса и прижаты ладонями к полу. Ноги подняты вверх до перпендикулярного полу положения.\n\nОпустите левую ногу вниз, совершая вдох.\n\nСделав маленькую задержку, на выдохе поднимите ногу обратно.\n\nТеперь аналогичное движение совершается правой ногой (левая остается в поднятом положении).\n\nПредставленный элемент направлен на концентрированную проработку нижней части пресса, помогая избавиться от жировых отложений в области пояса.\n\nСколько выполнять: 8-10 повторений на каждую ногу.`
                },
                {
                    exerciseName: 'Вытягивание разноименных рук и ног стоя на четвереньках', exerciseImg: ['uprajneniya-05.jpg'],
                    exerciseDescription:
                        `Элемент тренировки на пресс в домашних условиях выполняется с опорой на 4 точки.\n\nВстав на четвереньки, направьте взгляд перед собой.\n\nПосле этого вытяните правую ногу и левую руку так, чтобы они образовали сплошную линию со спиной.\n\nДополнительное втягивание мышц живота способствует стабилизации корпуса и похудению в целом.\n\nВ пиковой точке делаем небольшую паузу, поскольку это поможет сосредоточить напряжение в мышцах кора.\n\nПомимо пресса упражнение прорабатывает и укрепляет поясничный отдел, развивает координацию тела.\n\nСколько выполнять: 8-10 повторений на каждую сторону.`
                },
                {
                    exerciseName: 'Подъем корпуса к поднятым ногам', exerciseImg: ['107_2.jpg'],
                    exerciseDescription:
                        `Снова ложимся на спину и поднимаем ноги до перпендикулярного полу положения.\n\nРуки разведены в разные стороны и прижаты к коврику обратной стороной кисти.\n\nДалее поднимаем корпус и стараемся дотянуться до стоп.Движение верхними конечностями производится через стороны.\n\nВ пиковой точке делаем маленькую задержку, после чего возвращаемся в исходное положение.\n\nЭлемент оказывает комплексное воздействие на прямые, верхние и нижние мышцы живота, из-за чего считается одним из наиболее эффективных.\n\nСколько выполнять: 12-15 повторений.`
                },
                {
                    exerciseName: 'Подъемы ног с касанием рукой', exerciseImg: ['8da5b94849a73d67be5b175c5059cc54.jpg'],
                    exerciseDescription:
                        `Находясь в положении лежа на спине, разведите руки в разные стороны.\n\nПосле этого на выдохе поднимите вверх правую ногу и левую руку. Ладонь со стопой должны соприкоснуться в пиковой точке.\n\nСделав маленькую паузу, опустите конечности обратно, после чего приступите к очередному повторению на противоположную ногу.\n\nВыполняйте попеременно на обе стороны.\n\nПредставленное упражнение на пресс для мужчин позволяет проработать косые мышцы, формирующие рельефную и эстетичную зону пояса.\n\nСколько выполнять: 8-10 повторений на каждую сторону.`
                },
                {
                    exerciseName: 'Подъем корпуса с вытянутыми руками', exerciseImg: ['abs09.jpg'],
                    exerciseDescription:
                        `Не меняя положения, согните ноги в коленях и зафиксируйте на полной стопе. Руки вытянуты над головой.\n\nВаша задача — сделать подъем корпуса, не меняя положения верхних конечностей.В пиковой точке ладони должны коснуться носков.\n\nСложность элемента тренировки на пресс для мужчин в домашних условиях заключается в том, что вытянутые руки создают дополнительную нагрузку на мышцы пресса, позволяя тщательнее нагрузить их в ходе работы.\n\nСколько выполнять: 12-15 повторений.`
                },
                {
                    exerciseName: 'Подъем коленей в упоре лежа(Альпинист)', exerciseImg: ['uprazhnenie-alpinist.jpg'],
                    exerciseDescription:
                        `Приняв упор лежа, начинайте поочередно поднимать колени к груди.\n\nВ процессе работы представьте, будто шагаете по высоким ступенькам. Спина при этом должна оставаться ровной.\n\nДвигайтесь в среднем темпе, соблюдая четкую амплитуду движений.\n\nПоднимая колени, делайте маленькие паузы.\n\nГлавным преимуществом упражнения является комплексное воздействие сразу на несколько мышечных групп: пресс, поясница, руки, квадрицепсы. Одно из лучших упражнений для устранения живота мужчинам.\n\nСколько выполнять: 8-10 повторений на каждую сторону.`
                }
            ]
        },
        {
